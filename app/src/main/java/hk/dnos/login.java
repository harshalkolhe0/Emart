                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(login.this, ("logging in "+ user.getUid()),
                                    Toast.LENGTH_SHORT).show();

                            Intent log_int=new Intent(login.this,MainActivity.class);
                        ...
                        else
                        {
                            ...
                            Toast.makeText(login.this, "Email or password is invalid",
                                    Toast.LENGTH_SHORT).show();
                            // updateUI(null);
                        }
